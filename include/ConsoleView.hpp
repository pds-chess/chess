...
class Console {
 private:
  ...
  /**
   * @brief Print the menu with the options to make a move, propose a draw and
   * see all opposing pieces that have been captured.
   * @param match.
   */
  ...
  /**
   * @brief Choose what the new piece will be and call the promote pawn
   * function.
   * @param match.
 ...
 public:
  ...
  /**
   * @brief Print the menu with the options to create a new game and view
   * history.
   */
  void printMenu();
