...
class King: public Piece{
   ...
   */
        ~King();
    /**
   * @brief Validate the movement of King according to the basic King movement chess rule.
   ...
   */
        ...
        /**
   * @brief Override movePiece from Piece to check castle and set moved_ to true.
   * @param final_coordinates Coordinates witch King will try to move.
   */
