...
bool King::isCheck(const Board* board, Coordinates kingCoords, Color kingColor) {
    ...
    int pawnMoves[2][2] = {
        {kingColor == WHITE ? -1 : 1, -1}, // Peão atacando para cima e para a esquerda
        {kingColor == WHITE ? -1 : 1, 1}   // Peão atacando para cima e para a direita
    };
    for (int i = 0; i < 2; ++i) {
